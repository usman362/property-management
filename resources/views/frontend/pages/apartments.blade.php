            ...
            <div class="row align-items-center justify-content-center">
                <div class="col-lg-12">
                    <div class="page__hero__content">
                        <h1 class="wow fadeInUp">Apartments</h1>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6">
                        <div class="room__card">
                            ...
                            <div class="room__card__meta">
                                <a href="{{ route('apartment.details', $apartment->id) }}"
                                    class="room__card__title h5">{{ $apartment->apartment_name }}</a>
                                ...
                                <p class="font-sm">Our rooms offer a harmonious blend of comfort and elegance, designed to
                                    provide an exceptional stay for every guest.</p> --}}
                                <a href="{{ route('apartment.details', $apartment->id) }}" class="room__card__link">Discover
                                    More</a>
