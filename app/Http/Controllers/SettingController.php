...
class SettingController extends Controller
{
    ...
    public function recaptchaSetting()
    {
        ...
        return view('owner.setting.recaptcha-setting')->with($data);
    }
    public function mapBoxSetting()
    {
        $data['pageTitle'] = __("Map Box Setting");
        $data['subMapBoxSettingActiveClass'] = 'active';
        return view('owner.setting.map-box-setting')->with($data);
    }
    ...
    public function smsSetting()
    {
        ...
        return view('owner.setting.sms-setting')->with($data);
    }
    ...
    public function reminderSetting()
    {
        ...
        return view('owner.setting.reminder-setting')->with($data);
    }
    ...
    public function tenancySetting()
    {
        ...
        return view('owner.setting.tenancy-setting')->with($data);
    }
    ...
    public function frontendSetting()
    {
        ...
        return view('owner.setting.frontend-setting')->with($data);
    }
    ...
    public function listingSetting()
    {
        ...
        return view('owner.setting.listing-setting')->with($data);
    }
    ...
    public function agreementSetting()
    {
        ...
        return view('owner.setting.agreement-setting')->with($data);
    }
    ...
    public function cronSetting()
    {
        ...
        return view('owner.setting.cron-setting')->with($data);
    }
